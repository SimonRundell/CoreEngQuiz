  ...
  return (
    ...
    >
      <div className={['cm-float-ad__content', isMobile && isHovered && 'cm-float-ad__content--column'].filter(Boolean).join(' ')}>
        ...
        {!isMobile && (
          <span>
            &nbsp;&nbsp;&copy; {currentYear} Designed by Ryan May, Dept of Engineering. | eMail:{' '}
            <a href="mailto:ryanmay@exe-coll.ac.uk" className="cm-float-ad__link">
              ryanmay@exe-coll.ac.uk
            </a>
            &nbsp;|&nbsp;Created by Simon Rundell, Dept of ITDD,
            Exeter College | eMail:{' '}
        ...
        {isMobile && isHovered && (
          <div className="cm-float-ad__mobile-detail">
            <span>&copy; {currentYear} Designed by Ryan May, Dept of Engineering. </span>
            | eMail:{' '}
            <a href="mailto:ryanmay@exe-coll.ac.uk" className="cm-float-ad__link">
              ryanmay@exe-coll.ac.uk
            </a>
            <span>Created by Simon Rundell, Dept of ITDD, </span>
            <a href="mailto:simonrundell@exe-coll.ac.uk" className="cm-float-ad__link">
              simonrundell@exe-coll.ac.uk
            </a>
          <br></br><br></br>
